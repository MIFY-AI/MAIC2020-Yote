...
class YoteState(object):  # TODO: Link it to the core state.

    def __init__(self, board, next_player=-1, boring_limit=50):
        """The State of the Yote Game. It contains information regarding the game such as:
